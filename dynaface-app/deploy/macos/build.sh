...
pip install --upgrade https://data.heatonresearch.com/library/dynaface-0.1.6-py3-none-any.whl
cd deploy/macos
...
if [[ "$arch" == "x86_64" ]]; then
    ...
    pip install /Users/jeff/output/wheel/torch-2.4.0a0+git1cd4199-cp312-cp312-macosx_14_0_x86_64.whl
