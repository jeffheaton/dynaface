...
# Paths
weights_path_dft = pkg_resources.resource_filename('facial_analysis.spiga', 'models/weights')

import facial_analysis.spiga.inference.pretreatment as pretreat
from facial_analysis.spiga.models.spiga import SPIGA
