...
# My libs
from facial_analysis.spiga.data.loaders.augmentors.utils import rotation_matrix_to_euler

# Model file nomenclature
model_file_dft = pkg_resources.resource_filename('facial_analysis.spiga', 'data/models3D') + '/mean_face_3D_{num_ldm}.txt'
